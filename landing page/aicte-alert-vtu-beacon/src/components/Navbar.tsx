          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 7L12 12L22 7L12 2L2 7Z" stroke="#2563eb" strokeWidth="2" strokeLinejoin="round"/>
                <path d="M6 10V14C6 16.2091 8.68629 18 12 18C15.3137 18 18 16.2091 18 14V10" stroke="#2563eb" strokeWidth="2" strokeLinejoin="round"/>
              </svg>
